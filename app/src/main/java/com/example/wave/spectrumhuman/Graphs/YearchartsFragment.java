...
public class YearchartsFragment extends Fragment {
   XAxis xAxis;
    ...
    TextView year;
    Button left, right,swiperight,swipeleft;
    String Year,currentDate,testerName;
    SimpleDateFormat simpledateformat;
    View view;
    Button  arrow,downbtn;
    ...
    TextView testType_txt,txt_current_date,txt_current_user;
     ArrayList<Float> yearValuesArray;
    ArrayList<UrineresultsModel> monthDaysArray;
    SimpleDateFormat simpledateformatyearMonth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        testType_txt.setText(""+name.get(TabsGraphActivity.selectedTestTypeRecordIndex).toString());
    ...
    public void loadToggleAction(){
        if (TabsGraphActivity.isYearToggleChecked && toggleButton.isChecked()==true){
            layout.setVisibility(View.GONE);
            resultRecyclerView.setVisibility(View.VISIBLE);
            Log.e("toggleli","call"+toggleButton.isChecked()+""+TabsGraphActivity.isYearToggleChecked);

        }else {
            Log.e("togglelistelse","call"+toggleButton.isChecked()+""+TabsGraphActivity.isYearToggleChecked);
    ...
    public void setResultRecyclerViewData(){
        ...
        name.add(LanguageTextController.getInstance().currentLanguageDictionary.get(LanguagesKeys.OCCULT_BLOOD_RBC_KEY));
        name.add(LanguageTextController.getInstance().currentLanguageDictionary.get(LanguagesKeys.BILIRUBIN_VALUE_KEY));
        name.add(LanguageTextController.getInstance().currentLanguageDictionary.get(LanguagesKeys.UROBILIOGEN_KEY));
        name.add(LanguageTextController.getInstance().currentLanguageDictionary.get(LanguagesKeys.KETONES_KEY));
        name.add(LanguageTextController.getInstance().currentLanguageDictionary.get(LanguagesKeys.PROTEIN_KEY));
        name.add(LanguageTextController.getInstance().currentLanguageDictionary.get(LanguagesKeys.NITRATE_KEY));
        name.add(LanguageTextController.getInstance().currentLanguageDictionary.get(LanguagesKeys.GLUCOSE_KEY));
        name.add(LanguageTextController.getInstance().currentLanguageDictionary.get(LanguagesKeys.PH_KEY));
        name.add(LanguageTextController.getInstance().currentLanguageDictionary.get(LanguagesKeys.SG_KEY));
        name.add(LanguageTextController.getInstance().currentLanguageDictionary.get(LanguagesKeys.LEUKOCYTE_KEY));

        //
        resultRecyclerView = (RecyclerView)view.findViewById(R.id.year_list);
        resultRecyclerView.setNestedScrollingEnabled(false);
        resultsTableViewCell = new ResultsTableViewCell(name, getActivity().getApplication());
    ...
    public void actions(View view) {
        ...
        simpledateformatyearMonth = new SimpleDateFormat("yyyy/MM",Locale.ENGLISH);
        Year = simpledateformat.format(HomeActivityViewController.calander.getTime());
        year.setText(Year);

        left.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                HomeActivityViewController.calander.add(Calendar.YEAR, -1);
                Year = simpledateformat.format(HomeActivityViewController.calander.getTime());
    ...
    public void ids(View view) {
        ...
        toggleButton=(ToggleButton)view.findViewById(R.id.year_toggle);
        toggleButton.setChecked(TabsGraphActivity.isYearToggleChecked);

        toggleButton.setOnClickListener(mtoggle);
        ...
        toggleButton.setOnCheckedChangeListener( new CompoundButton.OnCheckedChangeListener()
        {
            ...
            public void onCheckedChanged(CompoundButton toggleButton, boolean isChecked)
            {
                if(isChecked) {
                    ...
                    resultRecyclerView.setVisibility(View.VISIBLE);
                    resultsTableViewCell.notifyDataSetChanged();
                    TabsGraphActivity.isYearToggleChecked=true;
                    toggleButton.setChecked(TabsGraphActivity.isYearToggleChecked);

                    Log.e("toggleChecked","call"+isChecked+""+TabsGraphActivity.isYearToggleChecked);
                ...
                }else
                {
                    ...
                    RelativeLayout layout = (RelativeLayout) getActivity().findViewById(R.id.linear_week);
                    layout.setVisibility(View.VISIBLE);
                    TabsGraphActivity.isYearToggleChecked=false;
                    toggleButton.setChecked(TabsGraphActivity.isYearToggleChecked);
                    load12MonthsData();
                }
            }
    ...
    public void previousDateAction()  {
        HomeActivityViewController.calanderForYear.add(Calendar.MONTH, -1);
        String nextDate = simpledateformatyearMonth.format(HomeActivityViewController.calanderForYear.getTime());
        Log.e("previousDate","call"+nextDate);
        currentDate = nextDate;
        Log.e("previouscurrentDate","call"+currentDate);
        HomeActivityViewController.selectedDateTextYear=currentDate;

        loadTableDataForDate(HomeActivityViewController.selectedDateTextYear);
        loadAnimatonToRecyclerView();

    }
    public void nextDateAction()  {
        HomeActivityViewController.calanderForYear.add(Calendar.MONTH, 1);//calander instance
        String nextDate = simpledateformatyearMonth.format(HomeActivityViewController.calanderForYear.getTime());
        currentDate = nextDate;
        Log.e("nextcurrentDate","call"+currentDate);
        HomeActivityViewController.selectedDateTextYear=currentDate;
        loadTableDataForDate(HomeActivityViewController.selectedDateTextYear);
        loadAnimatonToRecyclerView();
    ...
    public void loadTableDataForDate(String date) {
        ...
        try {
            HomeActivityViewController.selectedDateTextYear = objRecordDateString;
            Log.e("objRecordDateString",""+objRecordDateString);
            objRecords = UrineTestDataCreatorController.getInstance().getFilterArrayForMonthString(objRecordDateString);
            Log.e("objRecords",""+objRecords.size());

            Date datea = simpledateformatyearMonth.parse(HomeActivityViewController.selectedDateTextYear);
            HomeActivityViewController.calanderForYear.setTime(datea);
    ...
    /*public  void  loadFirstRecordData(){
        ...
        if (UrineResultsDataController.getInstance().allUrineResults.size()>0)
        {
            *//*currentDate=endDate;
            ...
            currentDate=simpledateformatyearMonth.format(HomeActivityViewController.calander.getTime());
            loadTableDataForDate(currentDate);
        }
        else
        {
   ...
   public void load12MonthsData(){
       HomeActivityViewController.selectedDateTextYear = null;
       monthDaysArray=new ArrayList<>();
       monthDaysArray.clear();
       yearValuesArray=new ArrayList<>();
       int monthsCount = 12;
       for(int i=0;i<monthsCount;i++)
       {
           yearValuesArray.add((float) 0.0);
       }
       String yearString = simpledateformat.format(HomeActivityViewController.calander.getTime());
       ...
       for (int i = 0; i <12; i++) {
           try {
               ...
               String queryString = yearString+"/"+monthText;
               Log.e("queryString",""+queryString);

               monthDaysArray= UrineTestDataCreatorController.getInstance().getFilterArrayForMonthString(queryString);
               UrineresultsModel objAvgModel = UrineTestDataCreatorController.getInstance().getUrineTestDataAvgObject(monthDaysArray);
               isDataAvailable = UrineTestDataCreatorController.getInstance().getIsDataAvailable(objAvgModel);

                   if (isDataAvailable){
                       HomeActivityViewController.selectedDateTextYear = queryString;
                   }
                   if (i == monthsCount-1)
                   {
                       if(HomeActivityViewController.selectedDateTextYear == null)
                       {
                           HomeActivityViewController.selectedDateTextYear = queryString;
                       }
                   }
                   ...
                   {
                       case 0:
                           yearValuesArray.set(i,(float)objAvgModel.getRbcValue());
                           break;

                       case 1:
                           yearValuesArray.set(i,(float)objAvgModel.getBillirubinValue());
                           break;

                       case 2:
                           yearValuesArray.set(i,(float)objAvgModel.getUroboliogenValue());
                           break;

                       case 3:
                           yearValuesArray.set(i,(float)objAvgModel.getKetonesValue());
                           break;

                       case 4:
                           yearValuesArray.set(i,(float)objAvgModel.getProteinValue());
                           break;

                       case 5:
                           yearValuesArray.set(i,(float)objAvgModel.getNitriteValue());
                           break;

                       case 6:
                           yearValuesArray.set(i,(float)objAvgModel.getGlucoseValue());
                           break;

                       case 7:
                           yearValuesArray.set(i,(float)objAvgModel.getPhValue());
                           break;
                       case 8:
                           yearValuesArray.set(i,(float)objAvgModel.getSgValue());
                           break;
                       case 9:
                           yearValuesArray.set(i,(float)objAvgModel.getLeucocyteValue());
                           break;
                   }
           } catch (ParseException e) {
               e.printStackTrace();
       ...
       Log.e("yearValuesArray",""+yearValuesArray);
       hideAllIndicationViews();
       loadTableDataForDate(HomeActivityViewController.selectedDateTextYear);
       setChart(yearValuesArray);
   }
    public void setChart(ArrayList<Float> values) {
       ...
       final double rangeValue = 240.0/(double)seperateCount;
        ...
        barData.setValueFormatter(new IValueFormatter() {
            ...
            public String getFormattedValue(float value, Entry entry, int dataSetIndex, ViewPortHandler viewPortHandler) {
                ...
                String dayText=String.valueOf(yearValuesArray.get(index));
                Log.e("yearchartsweekArray",""+yearValuesArray);
                switch (TabsGraphActivity.selectedTestTypeRecordIndex) {

                    case 0:
                        dayText = String.valueOf(yearValuesArray.get(index).intValue());
                        break;
                    case 3:
                        dayText = String.valueOf(yearValuesArray.get(index).intValue());
                        break;
                ...
                if(yearValuesArray.get(index) == 0)
                {
                    dayText="";
                }
                return dayText;
       ...
       /* xAxis.setValueFormatter(new IAxisValueFormatter() {
        ...
        xAxis.setValueFormatter(new IndexAxisValueFormatter(mYear));
        ...
        mChart.zoom(1.5f,0.0f,0.0f,0.0f);
    ...
    public void loadListData(){
        mChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                String objMonthString = simpledateformat.format(HomeActivityViewController.calander.getTime());
                 Log.e("objMonthString",""+objMonthString);
                index = index+1;
                ...
                HomeActivityViewController.selectedDateTextYear = objDateString;
                currentDate=HomeActivityViewController.selectedDateTextYear;
                //
                HomeActivityViewController.calanderForYear.setTime(HomeActivityViewController.calander.getTime());
                HomeActivityViewController.calanderForYear.set(Calendar.MONTH, index);
                //
    ...
    View.OnClickListener mdown=new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (state) {
                ...
                state = false;
                testType_txt.setText(name.get(TabsGraphActivity.selectedTestTypeRecordIndex));
                TabsGraphActivity.isFromYear=true;
    ...
    public class ResultsTableViewCell extends RecyclerView.Adapter<ResultsTableViewCell.ViewHolder>  {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.year_list_adapter, parent, false);
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position)
        {
            ...
            holder.testName.setText(name.get(position));
 ...
 public int changeLableColor(String condition){
     ...
     UrineTestDataCreatorController.getInstance().getTestColorForLable(val[0]);
